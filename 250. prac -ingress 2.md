...
app-space     default-backend   1/1     1            1           3m17s
app-space     webapp-video      1/1     1            1           3m17s
app-space     webapp-wear       1/1     1            1           3m17s
kube-system   coredns           2/2     2            2           6m33s
```

- `ingress`를 위한 네임스페이스, 컨피그맵, 서비스어카운트 생성
```
...
- 인그레스 컨트롤러 배포를 위한 디플로이먼트, 서비스 생성
```bash
apiVersion: apps/v1
kind: Deployment
metadata:
